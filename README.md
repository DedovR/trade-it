...
```ruby
gem 'trade_it', github: 'DedovR/trade-it'
```
...
All Error cases are handled by raising a subclass of `TradeIt::Errors::TradingException`, this object exposes a number of attributes that can you can `to_h` to the consumer.
